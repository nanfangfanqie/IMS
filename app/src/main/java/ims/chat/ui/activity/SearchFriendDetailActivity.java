...
public class SearchFriendDetailActivity extends IBaseActivity {
    ...
    private void initModel() {
        ...
        mUsername = intent.getStringExtra(ImsApplication.TARGET_ID);
        mAppKey = intent.getStringExtra(ImsApplication.TARGET_APP_KEY);
                        ...
                        ContactManager.declineInvitation(mToUserInfo.getUserName(), mToUserInfo.getAppKey(), "拒绝了您的好友请求", new BasicCallback() {
                            ...
                            public void gotResult(int responseCode, String responseMessage) {
                                ...
                                if (responseCode == 0) {
                                    ...
                                    setResult(ImsApplication.RESULT_BUTTON, btnIntent);
                                    finish();
                                }
                            }
                        });
                        ...
                        ContactManager.acceptInvitation(mToUserInfo.getUserName(), mToUserInfo.getAppKey(), new BasicCallback() {
                            ...
                            public void gotResult(int responseCode, String responseMessage) {
                                ...
                                if (responseCode == 0) {
                                    ...
                                    setResult(ImsApplication.RESULT_BUTTON, btnIntent2);
