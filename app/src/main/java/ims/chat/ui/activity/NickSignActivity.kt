...
class NickSignActivity : BaseActivity() {
    ...
    private fun initListener(flags: Int) {
        menu_title_bar!!.setOnClickListener {
    ...
    private fun initView() {
        ...
        menu_title_bar = findViewById(R.id.menu_title_bar) as Button?
        if (intent.getStringExtra("group_name") != null) {
            mEd_sign!!.setText(intent.getStringExtra("group_name"))
        }
        if (intent.getStringExtra("group_desc") != null) {
            mEd_sign!!.setText(intent.getStringExtra("group_desc"))
        }
    ...
    companion object {
        private val SIGN_COUNT = 250
        private val NICK_COUNT = 64
    }
}
