    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(ImsApplication.TARGET_ID, targetId);
                notificationIntent.putExtra(ImsApplication.TARGET_APP_KEY, appKey);
            }
            notificationIntent.putExtra(ImsApplication.CONV_TITLE, conv.getTitle());
