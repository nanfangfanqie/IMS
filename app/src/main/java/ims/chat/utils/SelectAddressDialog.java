...
import ims.chat.R;
import ims.chat.adapter.NumericWheelAdapter;
import ims.chat.application.ImsApplication;
import ims.chat.ui.activity.PersonalActivity;
import ims.chat.utils.citychoose.XmlParserHandler;
import ims.chat.utils.citychoose.model.CityModel;
import ims.chat.utils.citychoose.model.DistrictModel;
import ims.chat.utils.citychoose.model.ProvinceModel;
import ims.chat.utils.citychoose.view.WheelView;
import ims.chat.utils.citychoose.view.adapter.ArrayWheelAdapter;
import ims.chat.utils.citychoose.view.myinterface.OnWheelChangedListener;
...
//        window.setWindowAnimations(R.style.mystyle);
        ...
        year.setCurrentItem(curYear - ImsApplication.START_YEAR);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String str = String.format(Locale.CHINA,
                        "%4d-%2d-%2d", year.getCurrentItem() + ImsApplication.START_YEAR,//1900
...
//        window.setWindowAnimations(R.style.mystyle); // 添加动画
    ...
    private void initYear(PersonalActivity context) {
        NumericWheelAdapter numericWheelAdapter = new NumericWheelAdapter(context,
                ImsApplication.START_YEAR, ImsApplication.END_YEAR);
