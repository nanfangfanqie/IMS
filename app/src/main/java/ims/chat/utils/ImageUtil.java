...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(ImsApplication.getContext().getResources(), R.drawable.image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private static String getTempFilePath(String extension) {
        return StorageUtil.getWritePath(
                ImsApplication.getContext(),
                "temp_image_" + StringUtil.INSTANCE.get36UUID() + "." + extension,
    ...
    public static int[] getBoundWithLength(int maxSide, Object imageObject, boolean resizeToDefault) {
        ...
        if (String.class.isInstance(imageObject)) {
            ...
            bound = BitmapDecoder.decodeBound(ImsApplication.getContext().getResources(), (Integer) imageObject);
            width = bound[0];
            height = bound[1];
    ...
    public static Bitmap getBitmapFromDrawableRes(int res) {
        try {
            return getBitmapImmutableCopy(ImsApplication.getContext().getResources(), res);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
