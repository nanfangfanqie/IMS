...
import ims.chat.entity.NotificationClickEventReceiver;
 ...
 * 自定义Application
 */
public class ImsApplication extends com.activeandroid.app.Application {
    ...
    public static String PICTURE_DIR = "sdcard/IMS/pictures/";
    public static final String CONV_TITLE = "conv_title";
    public static final String TARGET_ID = "targetId";
    public static final String TARGET_APP_KEY = "targetAppKey";
    private static   Context context;
    public static int registerOrLogin = 1;
    private static final String CHAT_CONFIGS = "Chat_configs";
    ...
    public void onCreate() {
        ...
        SharePreferenceManager.init(getApplicationContext(), CHAT_CONFIGS);
        //设置Notification的模式
    ...
    public static void setPicturePath(String appKey) {
        if (!SharePreferenceManager.getCachedAppKey().equals(appKey)) {
            ...
            PICTURE_DIR = "sdcard/IMS/pictures/" + appKey + "/";
        }
    }
